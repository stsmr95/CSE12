...
public class ASTTester extends TestCase
{
 ...
 public void testProduct()
 {
  ...
  assertEquals("81.0 meters^2",theProd.eval(database).toString());
 }
 ...
 public void testQuotient()
 {
  ...
  assertEquals("1.0",theQuotient.eval(database).toString());
 }
 ...
 public void testDifference()
 {
  ...
  assertEquals("0.0 pennyweight",theDiff.eval(database).toString());
 }
 ...
 {
  uni.tokenize("--9 meters");
  AST theNegate = uni.parse();
  assertEquals("9.0 meters",theNegate.eval(database).toString());
 }

 public void testDefine()
 {
  uni.tokenize("def smoot 56 inches");
  AST define = uni.parse();
  assertEquals("56.0 inches",define.eval(database).toString());
 }
