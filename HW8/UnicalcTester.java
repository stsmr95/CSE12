...
public class UnicalcTester extends TestCase
{
	...
	public void testS()
	{
		...
		assertEquals("Product(Value(100.0),Value(1.0 meters))",unicalc.parse().toString());
		unicalc.tokenize("def smoot 67 inches");
		assertEquals("Define(smoot,Product(Value(67.0),Value(1.0 inches)))",unicalc.parse().toString());
	}
